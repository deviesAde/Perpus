...
if (!$data) {
    ...
    header("Location: dashboard_admin.php#konfirmasi-peminjaman");
    exit;
}
...
if ($data['status'] == 'Pending') {
    ...
    $update_peminjaman = mysqli_query($koneksi, "UPDATE peminjaman SET status = 'Dipinjam' WHERE id = $peminjaman_id");
    ...
    if ($update_peminjaman && $update_buku) {
        ...
        $_SESSION['alert'] = [
            'message' => 'Gagal mengkonfirmasi peminjaman.',
            'type' => 'error'
        ];
    }
    header("Location: dashboard_admin.php#konfirmasi-peminjaman");
    ...
    $_SESSION['alert'] = [
        'message' => 'Peminjaman tidak valid untuk dikonfirmasi.',
        'type' => 'error'
    ];
    header("Location: dashboard_admin.php#konfirmasi-peminjaman");
    exit;
